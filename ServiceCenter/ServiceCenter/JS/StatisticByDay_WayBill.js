$(function () {
    ...
    var GetDataURL = "/" + pub_WhichLang + "/StatisticByDay_WayBill/GetData?dYMD_Begin=";
    ...
    function LoadData() {
        $.ajax({
            url: GetDataURL + encodeURI($("#txtDate_Begin").val()) + "&dYMD_End=" + encodeURI($("#txtDate_End").val()) + "&Station=" + _$_ddlStation.combobox("getValue") + "&EmpNO=" + encodeURI(_$_ddlEmpNO.combobox("getValue")),
            type: "POST",
            cache: false,
            async: false,
            success: function (msg) {
                ...
                $('#container').highcharts({
                    ...
                    title: {
                        text: "[" + $("#txtDate_Begin").val() + "__" + $("#txtDate_End").val() + ']' + StatisticByDay_WayBill_JS_Tip1
                    },
                    subtitle: {
                        text: ''
                    },
                    ...
                    yAxis: {
                        min: 0,
                        title: {
                            text: StatisticByDay_WayBill_JS_Tip2
                        }
                    },
                    tooltip: {
