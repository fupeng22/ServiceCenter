...
(function () {
    ...
    Date.prototype.toLongDateTimeString = function () {
        ...
        var weekArray = new Array(" " + Default_JS_Sunday, " " + Default_JS_Monday, " " + Default_JS_Tuesday, " " + Default_JS_Wednesday, " " + Default_JS_Thursday, " " + Default_JS_Friday, " " + Default_JS_Saturday);
        ...
        if (hours >= 23 || hours <= 0) {
            timePath = Default_JS_Midnight;
        } else if (hours >= 1 && hours <= 5) {
            timePath = Default_JS_Morning;
        } else if (hours >= 6 && hours <= 7) {
            timePath = Default_JS_Morning;
        } else if (hours >= 8 && hours <= 11) {
            timePath = Default_JS_Morning;
        } else if (hours >= 12 && hours <= 13) {
            timePath = Default_JS_Noon;
        } else if (hours >= 14 && hours <= 17) {
            timePath = Default_JS_Afternoon;
        } else if (hours >= 18 && hours <= 19) {
            timePath = Default_JS_Evening;
        } else if (hours >= 20 && hours <= 22) {
            timePath = Default_JS_Night;
        }
        ...
        timeString = year + Default_JS_Year + month + Default_JS_Month + day + Default_JS_Day + weekDay + ", " + timePath + " " + hours + ":" + minutes + ":" + seconds;
        return timeString;
    };
