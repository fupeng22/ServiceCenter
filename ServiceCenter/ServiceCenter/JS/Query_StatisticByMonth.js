$(function () {
    var GetDataURL = "/" + pub_WhichLang + "/Query_StatisticByMonth/GetData?dYM_Begin=";
    ...
    function LoadData() {
        $.ajax({
            url: GetDataURL + encodeURI($("#txtDate_Begin").val()) + "&dYM_End=" + encodeURI($("#txtDate_End").val()) + "&Station=" + encodeURI($("#hid_DeviceName").val()) + "&EmpNO=" + "",
            type: "POST",
            cache: false,
            async: false,
            success: function (msg) {
                ...
                $('#container').highcharts({
                    ...
                    title: {
                        text: "[" + $("#txtDate_Begin").val() + "__" + $("#txtDate_End").val() + ']' + "单位月货物统计数据"
                    },
                    subtitle: {
                        text: ''
                    },
